...
"")
        ...
        self.win_plot_widget = GraphicsLayoutWidget(self.groupBox_2)
        self.win_plot_widget.setObjectName("win_plot_widget")
        self.gridLayout_15.addWidget(self.win_plot_widget, 0, 0, 1, 1)
        ...
        self.pushButton_start_cycle = QtWidgets.QPushButton(self.centralwidget)
        self.pushButton_start_cycle.setObjectName("pushButton_start_cycle")
        self.horizontalLayout_2.addWidget(self.pushButton_start_cycle)
        self.pushButton_end_cycle = QtWidgets.QPushButton(self.centralwidget)
        self.pushButton_end_cycle.setObjectName("pushButton_end_cycle")
        self.horizontalLayout_2.addWidget(self.pushButton_end_cycle)
        self.gridLayout_14.addLayout(self.horizontalLayout_2, 3, 0, 1, 1)
        self.horizontalLayout_3.addLayout(self.gridLayout_14)
        MainWindow.setCentralWidget(self.centralwidget)
        self.menubar = QtWidgets.QMenuBar(MainWindow)
        self.menubar.setGeometry(QtCore.QRect(0, 0, 904, 18))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.pushButton_start_cycle.setText(_translate("MainWindow", "Начать цикл"))
        self.pushButton_end_cycle.setText(_translate("MainWindow", "Завершить цикл"))
